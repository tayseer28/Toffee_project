...
public class Registration {
    ...
    public void WriteToFile(){
        ...
        try(FileWriter myWriter = new FileWriter("users.txt", true);
            ...
            bw.write(Integer.toString(userAccount.getId()));
            bw.write("\n");
            bw.write(userName);
            bw.write("\n");
            bw.write(password);
    ...
    public void register(){
        String pass, e, phone,user, otpp = new String();
            ...
            if(otpCode.equals(otpp)){
                userAccount = new UserAccount(userName,password, email, phoneNum, address);
                WriteToFile();
            }
            else {
